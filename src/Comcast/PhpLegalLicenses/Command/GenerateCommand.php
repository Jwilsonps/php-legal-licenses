...
class GenerateCommand extends DependencyLicenseCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('full', null, InputOption::VALUE_OPTIONAL, 'Show full licence text', false);
    }
    ...
    protected function generateLicensesCSV($dependencies)
    {
        ...
        $title = ['name', 'version', 'source', 'license'];
        ...
        foreach ($dependencies as $dependency) {
            $dependencyLists = [
                ...
                $this->fullLicenceText ? $this->getTextForDependency($dependency) : $this->getLicenceNames($dependency),
            ];
...
';
    ...
    protected function getTextForDependency($dependency)
    {
        ...
        $licenseNames = $this->getLicenceNames($dependency);
        $license = $this->fullLicenceText ? $this->getFullLicenseText($name) : '';
...
";
     ...
     * @return string
     */
    protected function getLicenceNames($dependency)
    {
        return isset($dependency['license']) ? implode(', ', $dependency['license']) : 'Not configured.';
    }
